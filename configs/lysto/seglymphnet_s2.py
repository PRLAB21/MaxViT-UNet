...
custom_imports = dict(
    imports=[
        ...
        'mmseg.models.backbones.LymphSeg_model',
    ],
...
# optimizer = dict(type='SGD', lr=0.0005, momentum=0.9, weight_decay=0.0001, nesterov=True)
lr_config = dict(_delete_=True, policy='step', warmup='linear', warmup_iters=500, warmup_ratio=0.0025, step=[12, 20, 28])
# lr_config = dict(policy='poly', power=0.9, min_lr=0.000001, by_epoch=True)
