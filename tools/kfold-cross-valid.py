...
from mmseg.utils import collect_env, get_root_logger, load_json_log

TEST_METRICS = ('mIoU', 'mDice', 'mAcc')
...
def parse_args():
    ...
    group_gpus.add_argument('--device', default='cuda', help='device used for training')
...
def train_single_fold(args, cfg, fold, distributed, seed):
    ...
    if len(cfg.workflow) == 2:
        ...
        val_dataset['dataset']['pipeline'] = cfg.data.train['dataset']['pipeline']
